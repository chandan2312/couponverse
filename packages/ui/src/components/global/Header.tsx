...
export const Header = ({ lang }: HeaderProps) => {
    const t = words.Header;

    return (
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-black/10 dark:border-white/10 px-4 md:px-10 py-3 bg-white dark:bg-background-dark">
            ...
            <div className="hidden md:flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                    <a
                        className="text-[#181311] dark:text-white/80 text-sm font-medium leading-normal hover:text-primary transition-colors"
                        href="#"
                    >
                ...
                <div className="flex gap-2">
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors">
                        <span className="truncate">{t.signup[lang]}</span>
                    </button>
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-black/5 dark:bg-white/10 text-[#181311] dark:text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-black/10 dark:hover:bg-white/20 transition-colors">
                        <span className="truncate">{t.login[lang]}</span>
                    </button>
                </div>
            </div>
        </header>
